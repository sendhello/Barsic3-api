...
from legacy import to_google_sheets
...
class BarsicReport2Service:
    ...
    def __init__(self):
        ...
        self.driver = getattr(MssqlDriverType, settings.mssql_driver_type).value
    ...
    def count_clients(
        ...
        try:
            ...
            logging.error(f'DRIVER={driver};SERVER={server};PORT=1433;DATABASE={database};UID={uid};PWD={pwd}')
        ...
        for group_name, groups in self.itogreport_group_dict.items():
            ...
            for oldgroup in groups:
                try:
                    ...
                    logger.info('Несоответствие конфигураций XML-файлов', f'Группа {oldgroup} не существует!\n'
                    f'KeyError: {e}')
    ...
    def agent_report_month(self):
        ...
        if self.agentreport_dict_month['ИТОГО'][''][1][2] != \
                ...
                self.agentreport_dict_month['Контрольная сумма']['Cумма'][0][1]:
            logger.info("Несоответствие Контрольных сумм.",
    ...
    def export_agent_report(self, agentreport_dict):
        ...
        if itog_sum != agentreport_dict['ИТОГО'][1]:
            ...
            logger.info(f'Ошибка. Отчет платежного агента', f'Ошибка. Отчет платежного агента: сумма строк '
                                                                 f'({itog_sum}) не равна строке ИТОГО '
                                                                 f'({agentreport_dict["ИТОГО"][1]})')
    ...
    def save_file(self, path, file):
        ...
        try:
            ...
            logger.info(f'Ошибка записи файла',
        ...
        if path_list:
            if self.use_yadisk:
                ...
                if self.yadisk.check_token():
                    ...
                    logger.info('Ошибка соединения с Yandex.Disc',
    ...
    def export_to_google_sheet(self):
        ...
        if self.finreport_dict['Дата'][0] + timedelta(1) != self.finreport_dict['Дата'][1]:
            ...
            logger.info('Ошибка экспорта в Google.Sheet',
